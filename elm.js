...
Elm.Combobox = Elm.Combobox || {};
Elm.Combobox.make = function (_elm) {
   "use strict";
   _elm.Combobox = _elm.Combobox || {};
   if (_elm.Combobox.values)
   return _elm.Combobox.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   model) {
      return function () {
         ...
         action);
         switch (_v0.ctor)
         {case "ChangeDataCurrent":
            return _U.replace([["dataCurrent"
                               ,_v0._0]
                              ,["isEdited"
                               ,_U.eq(_v0._0,
                               "") ? false : true]
            ...
            case "KeyUp":
            return function () {
                 var len = $List.length(model.dataModified);
                 return _U.eq(_v0._0,
                 40) ? _U.replace([["curTakeOption"
                                   ,_U.cmp(model.curTakeOption + 1,
                                   len) < 0 ? model.curTakeOption + 1 : model.curTakeOption]],
                 model) : _U.eq(_v0._0,
                 38) ? _U.replace([["curTakeOption"
                                   ,_U.cmp(model.curTakeOption,
                                   0) > 0 ? model.curTakeOption - 1 : 0]],
                 model) : _U.eq(_v0._0,
                 13) ? _U.replace([["dataCurrent"
                                   ,_U.eq(_L.fromArray([]),
                                   A2($List.drop,
                                   model.curTakeOption,
                                   model.dataModified)) ? "" : $List.head(A2($List.drop,
                                   model.curTakeOption,
                                   model.dataModified))]
                                  ,["isEdited",false]
                                  ,["curTakeOption",0]],
   ...
   var initialModel = F2(function (suggestions,
   maxTake) {
      return {_: {}
             ,curTakeOption: 0
             ,dataCurrent: ""
             ,dataList: suggestions
             ,dataModified: _L.fromArray([])
             ,isEdited: false
             ,listTake: maxTake};
   });
   ...
   var viewSuggestions = F2(function (chan,
   model) {
      return function () {
         var selectClass = function (i) {
            return _U.eq(i,
            model.curTakeOption) ? " combobox-active" : "";
         };
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("fadeIn combobox-list")]),
         A2($List.indexedMap,
         F2(function (i,x) {
            return A2($Html.div,
   ...
   var ChangeDataCurrent = function (a) {
   ...
   model) {
      ...
      _L.fromArray([A2($Html.input,
                   ...
                   _L.fromArray([]))
                   ,model.isEdited ? A2(viewSuggestions,
                   chan,
                   model) : A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([]))]));
   ...
   _elm.Combobox.values = {_op: _op
                          ,Model: Model
                          ,NoOp: NoOp
                          ,ChangeDataCurrent: ChangeDataCurrent
                          ,Choose: Choose
                          ,KeyUp: KeyUp
...
Elm.ComboboxTest = Elm.ComboboxTest || {};
Elm.ComboboxTest.make = function (_elm) {
   "use strict";
   _elm.ComboboxTest = _elm.ComboboxTest || {};
   if (_elm.ComboboxTest.values)
   return _elm.ComboboxTest.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "ComboboxTest",
   $Combobox = Elm.Combobox.make(_elm),
   $Countries = Elm.Countries.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $LocalChannel = Elm.LocalChannel.make(_elm),
   ...
   model) {
      return function () {
         switch (action.ctor)
         {case "ComboAction1":
            return _U.replace([["combo1"
                               ,A2($Combobox.update,
                               action._0,
                               model.combo1)]],
              model);
            case "ComboAction2":
            return _U.replace([["combo2"
                               ,A2($Combobox.update,
                               action._0,
                               model.combo2)]],
              model);}
   ...
   var initialModel = {_: {}
                      ,combo1: A2($Combobox.initialModel,
                      $Countries.list,
                      10)
                      ,combo2: A2($Combobox.initialModel,
                      $Countries.list,
                      5)};
   var ComboAction2 = function (a) {
      return {ctor: "ComboAction2"
             ,_0: a};
   };
   var ComboAction1 = function (a) {
      return {ctor: "ComboAction1"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   ...
   var view = function (model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("container combo-test")]),
      _L.fromArray([A2($Html.h2,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Combobox example (countries example)")]))
                   ,A2($Html.h3,
                   _L.fromArray([]),
   ...
   _elm.ComboboxTest.values = {_op: _op
                              ,Model: Model
                              ,NoOp: NoOp
                              ,ComboAction1: ComboAction1
                              ,ComboAction2: ComboAction2
                              ,initialModel: initialModel
                              ,view: view
                              ,main: main
...
Elm.Countries = Elm.Countries || {};
Elm.Countries.make = function (_elm) {
   "use strict";
   _elm.Countries = _elm.Countries || {};
   if (_elm.Countries.values)
   return _elm.Countries.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var list = _L.fromArray(["Afghanistan"
                           ,"Albania"
                           ,"Algeria"
                           ,"American Samoa"
                           ,"AndorrA"
